...
export const Banner = () => {
  return (
    ...
    <div className="container py-14 relative">
        <div>
            <h1 className='capitalize tracking-wider py-8 font-semibold text-2x text-dark text-center '>Taste The healthy difference</h1>
        ...
        {/* bg fruits png */}
        <div className='absolute top-5 left-16 opacity-50 sm:opacity-100 sm:bottom-0 sm:left-0 '> <img data-aos='fade-right' className='max-w-[160px]' src={Leaf} alt="" /></div>
        <div className='absolute bottom-16 left-16 sm:bottom-0 sm:left-0 opacity-50 sm:opacity-100'> <img data-aos='fade-right' className='max-w-[280px]' src={Tomato} alt="" /></div>
        <div className='absolute right-16 top-10 sm:right-20 opacity-50 sm:opacity-100'> <img data-aos='fade-left' className='max-w-[200px]' src={Lemon} alt="" /></div>
        <div className='hidden sm:block absolute bottom-0 right-0'><img className='max-w-[200px]' data-aos='fade-left' src={Apple} alt="" /></div>
        <div className='absolute top-1/2 translate-y-1/2 left-1/3 translate-x-1/2 opacity-50 sm:opacity-100'> <img data-aos='fade-up' src={Kiwi} className='max-w-[180px]' alt="" /></div>
    </div>
    </>
  )
}
