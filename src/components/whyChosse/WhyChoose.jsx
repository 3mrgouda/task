  ...
  return (
    ...
    <div className="py-14 md:py-28 bg-gray-50">
      <div className="container">
        {/* Heading section */}
        <h1 data-aos="fade-up"  className='capitalize tracking-wider py-8 font-semibold text-2xl text-dark text-center'>why choose uS</h1>
        {/* card section  */}
        <div>
          <div data-aos="fade-up" data-aos-delay="300" className="grid md:grid-cols-4 grid-cols-2 gap-14 sm:gap-4">
            {/* 1st card */}
