...
const ContentAi = () => {
    ...
    return (
        <div className='xl:w-11/12 w-full xl:mx-auto ' >
            ...
            <div className='  flex xl:w-11/12 flex-col w-full xl:flex-row xl:items-center xl:justify-between mx-auto gap-2'>
                <div className="logo flex items-center justify-between text-5xl"><div className="flex items-center">Begin <img src={LogoIcon} className='inline-block w-[50px]' alt="" /><span className='font-bold'>Front</span></div> <div className='max-sm:block hidden w-20 '></div>
            ...
            <div className=' flex items-center mt-28 justify-center  mx-auto'>
                {/* grid system */}
